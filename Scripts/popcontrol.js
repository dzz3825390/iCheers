...
function LabelCheckInfo(){
    ...
    var WindowContent = [
        '<p>裸瓶難免有微小瑕疵，瑕疵率約2%以下，如遇下列狀況，我們將視為正常品出貨，<label style="color:#c20012;">「不會」另行通知</label>：<br/>1)酒標破損面積1mm以下且不影響主視覺<br/>2)十年以上老酒標污漬、泛黃<br/>3)酒標摺痕（常見於手工貼標商品）<br/>4)酒標有凸起氣泡、面積1cm以下且只有一顆<br/>5)紙盒有凹痕但未掉色<br/>6)背標有污漬、破損但不影響閱讀。</p>',
    ]
