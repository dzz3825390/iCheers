...
function DeliveryInfoEdit(){
        ...
        switch (DeliveryInfo[0].DeliveryType) {
            ...
            case 'Motocycle':
                $('.recorded_data').append('<div class="row"><div class="title">配送方式</div><div id="DeliveryInfo_project" class="sex_radio CLEARBOTH"><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_T-Cat"><span>宅配到府</span></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_Motocycle" checked="checked"><span>當日配(限雙北區域、付款方式僅限匯款/刷卡)</span><div class="extend"><label style="color:#c20012;">賀上線，限時免運！</label><br/>將於上班日（周一至周五，國定假日除外）15:00前出貨、最晚19:00到貨；若已截單（超過當日14:00）將順延至下一個工作當日出貨。</div></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_SelfCollect"><span>預約自取(免運費)</span><div class="extend">請於抵達前1小時來電確認已備好貨，<br/>可預約時段：上班日11:00~12:00、16:00~18:00。<br/>地址：新北市汐止區中興路43號1樓 國揚矽谷大廳（開車可臨停在大廳對面）</div></div></div></div>');
            break;
            /*
            case 'Car':
            ...
            */
            case 'T-cat':
                $('.recorded_data').append('<div class="row"> <div class="title">配送方式</div><div id="DeliveryInfo_project" class="sex_radio CLEARBOTH"><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_T-Cat" checked="checked"><span>宅配到府</span></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_Motocycle"><span>當日配(限雙北區域、付款方式僅限匯款/刷卡)</span><div class="extend"><label style="color:#c20012;">賀上線，限時免運！</label><br/>將於上班日（周一至周五，國定假日除外）15:00前出貨、最晚19:00到貨；若已截單（超過當日14:00）將順延至下一個工作當日出貨。</div></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_SelfCollect"><span>預約自取(免運費)</span><div class="extend">請於抵達前1小時來電確認已備好貨，<br/>可預約時段：上班日11:00~12:00、16:00~18:00。<br/>地址：新北市汐止區中興路43號1樓 國揚矽谷大廳（開車可臨停在大廳對面）</div></div></div></div>');
            break;

            case 'SelfCollect':
                $('.recorded_data').append('<div class="row"><div class="title">配送方式</div><div id="DeliveryInfo_project" class="sex_radio CLEARBOTH"><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_T-Cat"><span>宅配到府</span></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_Motocycle"><span>當日配(限雙北區域、付款方式僅限匯款/刷卡)</span><div class="extend"><label style="color:#c20012;">賀上線，限時免運！</label><br/>將於上班日（周一至周五，國定假日除外）15:00前出貨、最晚19:00到貨；若已截單（超過當日14:00）將順延至下一個工作當日出貨。</div></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_SelfCollect" checked="checked"><span>預約自取(免運費)</span><div class="extend">請於抵達前1小時來電確認已備好貨，<br/>可預約時段：上班日11:00~12:00、16:00~18:00。<br/>地址：新北市汐止區中興路43號1樓 國揚矽谷大廳（開車可臨停在大廳對面）</div></div></div></div>');
            break;            
            }
        //配送時間
        if (DeliveryInfo_FormStatus == 'NewCustomers'){
...
function CWC_DeliveryInfoEdit(){
        ...
        switch (DeliveryInfo[0].DeliveryType) {
            case 'SuperExpress':
                $('.recorded_data').append('<div class="row"><div class="title">配送方式</div><div id="DeliveryInfo_project" class="sex_radio CLEARBOTH"><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_T-Cat"><span>宅配到府</span></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_Motocycle"><span>當日配(限雙北區域、付款方式僅限匯款/刷卡)</span><div class="extend"><label style="color:#c20012;">賀上線，限時免運！</label><br/>將於上班日（周一至周五，國定假日除外）15:00前出貨、最晚19:00到貨；若已截單（超過當日14:00）將順延至下一個工作當日出貨。</div></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_SuperExpress" checked="checked"><span>特急件(限雙北區域、付款方式僅限匯款/刷卡)</span><div class="extend">將於上班日（周一至周五，國定假日除外）火速出貨，歡迎備註說明，我們會盡力達成您的期望；若已截單（超過當日17:00）將順延至下個工作日急件出貨。特急件將加收運費$300，若滿免運門檻則加收$100。</div></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_SelfCollect"><span>預約自取(免運費)</span><div class="extend">請於抵達前1小時來電確認已備好貨，<br/>可預約時段：上班日11:00~12:00、16:00~18:00。<br/>地址：新北市汐止區中興路43號1樓 國揚矽谷大廳（開車可臨停在大廳對面）</div></div></div></div>');
            break;

            case 'Motocycle':
                $('.recorded_data').append('<div class="row"><div class="title">配送方式</div><div id="DeliveryInfo_project" class="sex_radio CLEARBOTH"><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_T-Cat"><span>宅配到府</span></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_Motocycle" checked="checked"><span>當日配(限雙北區域、付款方式僅限匯款/刷卡)</span><div class="extend"><label style="color:#c20012;">賀上線，限時免運！</label><br/>將於上班日（周一至周五，國定假日除外）15:00前出貨、最晚19:00到貨；若已截單（超過當日14:00）將順延至下一個工作當日出貨。</div></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_SuperExpress"><span>特急件(限雙北區域、付款方式僅限匯款/刷卡)</span><div class="extend">將於上班日（周一至周五，國定假日除外）火速出貨，歡迎備註說明，我們會盡力達成您的期望；若已截單（超過當日17:00）將順延至下個工作日急件出貨。特急件將加收運費$300，若滿免運門檻則加收$100。</div></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_SelfCollect"><span>預約自取(免運費)</span><div class="extend">請於抵達前1小時來電確認已備好貨，<br/>可預約時段：上班日11:00~12:00、16:00~18:00。<br/>地址：新北市汐止區中興路43號1樓 國揚矽谷大廳（開車可臨停在大廳對面）</div></div></div></div>');
            break;
            /*
            case 'Car':
                $('.recorded_data').append('<div class="row"><div class="title">配送方式</div><div id="DeliveryInfo_project" class="sex_radio CLEARBOTH"><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_Motocycle"><span>機車當日配到府 (雙北特定區域、1400前)</span></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_Car" checked="checked"><span>汽車當日配需下樓自取 (雙北特定區域、1400前)</span></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_T-Cat"><span>宅配到府</span></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_SuperExpress"><span>特急件2hr內到貨<label class="icon_question" id="SuperExpressInfo">?</label> (雙北特定區域、1700前)</span></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_SelfCollect"><span>自取<label class="icon_question" id="SelfCollectInfo">?</label> </span></div></div></div>');
            ...
            */
            case 'T-cat':
                $('.recorded_data').append('<div class="row"><div class="title">配送方式</div><div id="DeliveryInfo_project" class="sex_radio CLEARBOTH"><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_T-Cat" checked="checked"><span>宅配到府</span></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_Motocycle"><span>當日配(限雙北區域、付款方式僅限匯款/刷卡)</span><div class="extend"><label style="color:#c20012;">賀上線，限時免運！</label><br/>將於上班日（周一至周五，國定假日除外）15:00前出貨、最晚19:00到貨；若已截單（超過當日14:00）將順延至下一個工作當日出貨。</div></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_SuperExpress"><span>特急件(限雙北區域、付款方式僅限匯款/刷卡)</span><div class="extend">將於上班日（周一至周五，國定假日除外）火速出貨，歡迎備註說明，我們會盡力達成您的期望；若已截單（超過當日17:00）將順延至下個工作日急件出貨。特急件將加收運費$300，若滿免運門檻則加收$100。</div></div><div class="CLEARBOTH"><input type="radio" name="project" id="DeliveryType_SelfCollect"><span>預約自取(免運費)</span><div class="extend">請於抵達前1小時來電確認已備好貨，<br/>可預約時段：上班日11:00~12:00、16:00~18:00。<br/>地址：新北市汐止區中興路43號1樓 國揚矽谷大廳（開車可臨停在大廳對面）</div></div></div></div>');
            break;
